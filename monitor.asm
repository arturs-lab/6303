...
CPLD	equ $10fd	; base address of CPLD
...
TMOFVEC	ds	3       ; TIMER OVER FLOW INTERRUPT VECTOR
TMOCVEC	ds	3	; TIMER OUTPUT COMPARE INTERRUPT VECTOR
TMICVEC	ds	3       ; TIMER INPUT CAPTURE INTERRUPT VECTOR
IRQVEC	ds	3       ; IRQ INTERRUPT VECTOR
SWIVEC	ds	3       ; SWI INTERRUPT VECTOR
NMIVEC	ds	3	; NMI INTERRUPT VECTOR
...
PROMPTX	dc	$0D,$0A
	...
	dc	$04
HELPTX	dc	$0D,$0A,$0A
	dc	"MC3 monitor 1.4.1"
	dc	$0D,$0A
	dc	"Daniel Tufvesson 2013-2015"
	dc	$0D,$0A,$0D,$0A
	dc	" G  Go (RTI)"
	dc	$0D,$0A
	dc	" J  Jump to address"
	dc	$0D,$0A
	dc	" L  Load S19 from console"
	dc	$0D,$0A
	dc	" MC Memory change"
	dc	$0D,$0A
	dc	" MD Memory dump"
	...
	dc	$0D,$0A
	dc	" RS Change stack pointer"
	dc	$0D,$0A
	dc	" RM Reset stack pointer"
	dc	$0D,$0A
	dc	" P  Select I/O page"
	dc	$0D,$0A
	dc	" S  Single step"
	dc	$0D,$0A
	dc	" X  Enter extended ROM"
	dc	$0D,$0A,$04
REGTX	dc     $0D,$0A
...
;**********
; START FROM RESET
RESET	LDX #RAMLO		; fill RAM with a known pattern
	LDAA	#$AA
.1	STAA 0,X
	INX
	CPX #RAMHI
...
; VECTORS
	...
	dc.w     SWIVEC	; FFFA-B	SOFTWARE INTERRUPT
